...
```xml
<kanban:SfKanban SwimlaneKey="IndicatorColorKey"
                 ItemsSource="{Binding TaskDetails}"/>
```

**C#:**
```csharp
kanban.SwimlaneKey = "IndicatorColorKey";
```

**Example Data:**
```csharp
new KanbanModel { IndicatorColorKey = "High", /* ... */ },
new KanbanModel { IndicatorColorKey = "Normal", /* ... */ },
new KanbanModel { IndicatorColorKey = "High", /* ... */ },
```
...
Shows the value of the grouping property (Assignee, IndicatorColorKey, etc.)
...
new KanbanModel { IndicatorColorKey = "High", /* ... */ },
new KanbanModel { IndicatorColorKey = "Normal", /* ... */ },
new KanbanModel { IndicatorColorKey = "Low", /* ... */ },
```
